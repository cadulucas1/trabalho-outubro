...
class BancoApp:
    ...
    def create_login_widgets(self):
        ...
        self.entry_titular_login = tk.Entry(self.frame1, font=('SourceSansPro-Bold', 20, 'bold'), bg='#c6d1e1', fg='#000000', width=30)
        self.entry_titular_login.place(x=0, y=30)

        self.label_senha_login = tk.Label(self.frame1, text="Senha:", bg='#FFFAFA', font=('SourceSansPro-Bold', 24, 'bold'))
        self.label_senha_login.place(x=20, y=600)

        self.entry_senha_login = tk.Entry(self.frame1, show="*", font=('SourceSansPro-Bold', 20, 'bold'), width=30, bg='#c6d1e1', fg='#000000')
        self.entry_senha_login.place(x=25, y=650)
        ...
        self.label_cadastro.place(x=20, y=700)
