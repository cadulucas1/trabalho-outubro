...
class BancoApp:
    ...
    #imagem 
     imagem_original = Image.open(r"C:\Users\CarlosGonzalez\Desktop\PyT\trabalho\do-utilizador.png")
     imagem_redimensionada = imagem_original.resize((338, 644), Image.Resampling.LANCZOS)
    ...
    def create_login_widgets(self):
        ...
        self.label_imagem = tk.Label(self.root, image=self.img1)
