...
class BancoApp:
    ...
    def create_login_widgets(self):
        ...
        frame = tk.Frame(self.root, bg='#FFFAFA')
        frame.place(relx=0.03, rely=0.5, anchor='w')

        self.label_bemvindo = tk.Label(text="Faça seu login", font=('SourceSansPro-Bold 40 bold'), bg ="#FFFAFA", fg = "#4270A8")
        self.label_bemvindo.place(x=100 ,y=70)

        self.label_titular_login = tk.Label(frame, text="CPF:",font=('SourceSansPro-Bold 24 bold'),  bg='#FFFAFA')
        self.label_titular_login.grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.entry_titular_login = tk.Entry(frame, font=('SourceSansPro-Bold 20 bold'))
        self.entry_titular_login.grid(row=0, column=1, padx=10, pady=5)

        self.label_senha_login = tk.Label(frame, text="Senha:",bg='#FFFAFA',font=('SourceSansPro-Bold 24 bold'))
        self.label_senha_login.grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.entry_senha_login = tk.Entry(frame, show="*",font=('SourceSansPro-Bold 20 bold'))
        self.entry_senha_login.grid(row=1, column=1, padx=10, pady=5)

        self.button_login = tk.Button(frame, text="Login", command=self.login, font=('SourceSansPro-Bold 20 bold'), bg='#4270A8', fg='#FFFAFA' )
        ...
        self.label_textologo1 = tk.Label(text='''Ajudando pessoas com um banco online!''', font=('SourceSansPro-Bold 36 bold'), bg ="#4270A8", fg = "#FFFAFA")
        self.label_textologo1.place(x=1000 ,y=800)
        ...
        self.label_imagem2.place(relx=0.675, rely=0.5, anchor='center')
